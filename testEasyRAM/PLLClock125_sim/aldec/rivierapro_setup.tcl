...
# ACDS 17.0 595 linux 2019.03.08.16:46:43
# ----------------------------------------
...
# ----------------------------------------
# If PLLClock125 is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "PLLClock125"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/PLLClock125.vo"
}
