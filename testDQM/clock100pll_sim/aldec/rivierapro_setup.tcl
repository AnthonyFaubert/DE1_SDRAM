...
# ACDS 17.0 595 linux 2019.03.05.12:05:08
# ----------------------------------------
...
# ----------------------------------------
# If clock100pll is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "clock100pll"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/clock100pll.vo"
}
